...
metadata
{
	definition(name: "HubConnect CTBulb", namespace: "shackrat", author: "Steve White", importUrl: "https://raw.githubusercontent.com/HubitatCommunity/HubConnect/master/UniversalDrivers/HubConnect-Bulb.groovy")
	{
		capability "Switch"
...
def sync()
{
	...
	parent.syncDevice(device.deviceNetworkId, "ctbulb")
